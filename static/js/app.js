...
// Checking to see if Data is showing up and linked properly
...
filterBtn.on("click", function() {
    ...
    // Had to google to find how to clear data but some reason would not work with variable tbody
    // Also had to create an "id" in html in order to properly clear the data in the tbody
